...
-->
  ...
  <meta content="" name="description">
    <title>Sistem Pakar mendiagnosa penyakit pada tanaman padi </title>
  ...
  <body class="hold-transition sidebar-mini">
    <div class="wrapper">
      ...
      <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>
          <h6 class="login-box-msg">Sistem Pakar Mendiagnosa Penyakit pada Tanaman Padi &copy; 2025</h6>
          </a>.
        </strong>
      </footer>
    </div>
