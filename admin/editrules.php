...
<body>
  <section>
    <form id="form1" name="form1" method="post" action="./updaterekap.php" enctype="multipart/form-data">
      <div class="mt-5">
        <table width="700" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#ffffff">
          <tr>
            <td style="background:linear-gradient(to top, #0CC, #09C);"><strong>Kode Rekap : <?php echo $_GET['kdpenyakit']; ?></strong></td>
            <td class=" ps-5" style="background:linear-gradient(to top, #0CC, #09C);"><strong class="ps-2">&nbsp;Edit Data Rekap</strong></td>
          </tr>
          <tr class="mt-4">
            <td colspan="2">
              <ul style="list-style:none;" class="mt-3">
                ...
                while ($row = mysqli_fetch_array($query)) {
                  ...
                  $kd_gejala = $row['id'];
                  $kueri = mysqli_query($koneksi, "SELECT * FROM tb_rekap WHERE id_penyakit='$kd_penyakit' AND id_gejala='$kd_gejala' ORDER BY id_gejala desc ");
          ...
          <tr>
            ...
            <td>
              <div class=" mt-3">
                <a href="./rekap.php"><input class="updaterekap" type="submit" name="Submit" value="Update Rekap" />
