  ...
  <div class="container-fluid">
    ...
    <div class="col-lg-3 col-6">
      ...
      <div class="small-box bg-primary">
        <div class="inner">
          <h3><?=caridata($mysqli,"select count(*) from riwayat_diagnosa")?><sup style="font-size: 20px"></sup></h3>
        ...
        <a href="?hal=riwayat" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
      </div>
    </div>
    <!-- ./col -->
